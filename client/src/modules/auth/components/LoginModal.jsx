    ...
    <Modal isOpen={isOpen} handleModalClose={handleModalClose}>
      <div className='bg-white-1 rounded-[16px] desktop:rounded-[8px] drop-shadow-md desktop:min-w-[500px]'>
        ...
        <div className='py-4 px-16'>
          ...
          <input className='text-black min-h-[47px] placeholder:text-black px-12 py-4 w-full border-1 border-gray-4 rounded-lg text-14' value={values.username} onChange={handleInputChange.bind(null, { id: 'username'})} />
        </div>
        <div className='py-4 px-16'>
          <p className='text-gray-4 text-14 pb-4'>Password</p>
          <input className='text-black min-h-[47px] placeholder:text-black px-12 py-4 w-full border-1 border-gray-4 rounded-lg text-14' value={values.password} onChange={handleInputChange.bind(null, { id: 'password'})} />
        </div>
        <div className='p-16'>
          <Button className='font-bold w-full' onClick={handleInitLogin}>Login</Button>
        </div>
      </div>
    </Modal>
  )
